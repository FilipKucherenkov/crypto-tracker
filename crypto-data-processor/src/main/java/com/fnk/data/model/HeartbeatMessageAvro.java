...
public class HeartbeatMessageAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static HeartbeatMessageAvro.Builder newBuilder() {
    return new HeartbeatMessageAvro.Builder();
  }
   ...
   * @return A new HeartbeatMessageAvro RecordBuilder
   */
  public static HeartbeatMessageAvro.Builder newBuilder(HeartbeatMessageAvro.Builder other) {
    if (other == null) {
      return new HeartbeatMessageAvro.Builder();
    } else {
      return new HeartbeatMessageAvro.Builder(other);
    }
  }
   ...
   * @return A new HeartbeatMessageAvro RecordBuilder
   */
  public static HeartbeatMessageAvro.Builder newBuilder(HeartbeatMessageAvro other) {
    if (other == null) {
      return new HeartbeatMessageAvro.Builder();
    } else {
      return new HeartbeatMessageAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HeartbeatMessageAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(HeartbeatMessageAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(HeartbeatMessageAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder setSequence(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder clearSequence() {
      sequence = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder setProductId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder clearProductId() {
      product_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder setTime(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public HeartbeatMessageAvro.Builder clearTime() {
      time = null;
