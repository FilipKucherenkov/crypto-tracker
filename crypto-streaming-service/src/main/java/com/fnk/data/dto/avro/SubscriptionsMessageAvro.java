...
public class SubscriptionsMessageAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<com.fnk.data.dto.avro.ChannelAvro> channels;
   ...
   */
  public SubscriptionsMessageAvro(java.lang.String type, java.util.List<com.fnk.data.dto.avro.ChannelAvro> channels) {
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: channels = (java.util.List<com.fnk.data.dto.avro.ChannelAvro>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.fnk.data.dto.avro.ChannelAvro> getChannels() {
    return channels;
  }
   ...
   * @param value the value to set.
   */
  public void setChannels(java.util.List<com.fnk.data.dto.avro.ChannelAvro> value) {
    this.channels = value;
  }
   ...
   */
  public static com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder newBuilder() {
    return new com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder();
  }
   ...
   * @return A new SubscriptionsMessageAvro RecordBuilder
   */
  public static com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder newBuilder(com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder other) {
    if (other == null) {
      return new com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder();
    } else {
      return new com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder(other);
    }
  }
   ...
   * @return A new SubscriptionsMessageAvro RecordBuilder
   */
  public static com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder newBuilder(com.fnk.data.dto.avro.SubscriptionsMessageAvro other) {
    if (other == null) {
      return new com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder();
    } else {
      return new com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SubscriptionsMessageAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fnk.data.dto.avro.SubscriptionsMessageAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder setChannels(java.util.List<com.fnk.data.dto.avro.ChannelAvro> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.SubscriptionsMessageAvro.Builder clearChannels() {
      channels = null;
    ...
    public SubscriptionsMessageAvro build() {
      try {
        ...
        record.channels = fieldSetFlags()[1] ? this.channels : (java.util.List<com.fnk.data.dto.avro.ChannelAvro>) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (com.fnk.data.dto.avro.ChannelAvro e0: this.channels) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<com.fnk.data.dto.avro.ChannelAvro> a0 = this.channels;
      if (a0 == null) {
        a0 = new SpecificData.Array<com.fnk.data.dto.avro.ChannelAvro>((int)size0, SCHEMA$.getField("channels").schema());
        this.channels = a0;
      } else a0.clear();
      SpecificData.Array<com.fnk.data.dto.avro.ChannelAvro> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.fnk.data.dto.avro.ChannelAvro>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          com.fnk.data.dto.avro.ChannelAvro e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new com.fnk.data.dto.avro.ChannelAvro();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
