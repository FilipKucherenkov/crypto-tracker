...
public class ChannelAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.fnk.data.dto.avro.ChannelAvro.Builder newBuilder() {
    return new com.fnk.data.dto.avro.ChannelAvro.Builder();
  }
   ...
   * @return A new ChannelAvro RecordBuilder
   */
  public static com.fnk.data.dto.avro.ChannelAvro.Builder newBuilder(com.fnk.data.dto.avro.ChannelAvro.Builder other) {
    if (other == null) {
      return new com.fnk.data.dto.avro.ChannelAvro.Builder();
    } else {
      return new com.fnk.data.dto.avro.ChannelAvro.Builder(other);
    }
  }
   ...
   * @return A new ChannelAvro RecordBuilder
   */
  public static com.fnk.data.dto.avro.ChannelAvro.Builder newBuilder(com.fnk.data.dto.avro.ChannelAvro other) {
    if (other == null) {
      return new com.fnk.data.dto.avro.ChannelAvro.Builder();
    } else {
      return new com.fnk.data.dto.avro.ChannelAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ChannelAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fnk.data.dto.avro.ChannelAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fnk.data.dto.avro.ChannelAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.ChannelAvro.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.ChannelAvro.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.ChannelAvro.Builder setProductIds(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.ChannelAvro.Builder clearProductIds() {
      product_ids = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.ChannelAvro.Builder setAccountIds(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fnk.data.dto.avro.ChannelAvro.Builder clearAccountIds() {
      account_ids = null;
